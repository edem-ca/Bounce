...
public class GameObj {
	...
	/** Acceleration of a jumping/airborne object*/
	public int a_x;
	public int a_y;
	...
	//additonal potential parameters for objects
	...
	public boolean isStill(GameObj ob){
		return (this.willIntersect(ob));
	}
	...
	public void bounce(Direction d) {
		if (d == null) return;
		switch (d) {
		case UP:    v_y = Math.abs(v_y/2); break;  
		case DOWN:  v_y = -Math.abs(v_y/2); break;
